                    ...
                    <form action="{{url('/products')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label for="pricec">Precio de compra</label>
                                    <input type="number" class="form-control" name="pricec"
                                        value="{{ old('pricec' , $product->pricec) }}">
                                    @include('layouts.error', ['name' => 'pricec'])
                                </div>
